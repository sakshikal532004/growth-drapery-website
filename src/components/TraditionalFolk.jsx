    ...
    <div className="traditional-page">
      <style>{`
        * { box-sizing: border-box; }
        ...
        .traditional-footer div {
          display: flex;
          flex-direction: column;
          gap: 5px;
        }
        .traditional-footer strong {
          color: #e8dcc8;
          font-size: 12px;
          letter-spacing: 2px;
        }
        ...
        @media (max-width: 600px) {
          ...
          .traditional-header { padding: 15px 18px; }
          .header-brand span { font-size: 8px; letter-spacing: 2px; }
          .back-collection-btn { padding: 9px 14px; font-size: 11px; }

          .traditional-hero { padding: 60px 18px; }
          .traditional-hero h1 { font-size: 55px; letter-spacing: -3px; }
          .traditional-hero p { font-size: 14px; }

          .traditional-slider-section { padding: 20px 18px 70px; }
          ...
          .traditional-info { padding: 65px 0; }
          ...
          .traditional-footer { flex-direction: column; align-items: flex-start; padding: 30px 18px; }
        }
      `}</style>
      ...
      <section className="traditional-hero">
        <div className="traditional-hero-content">
          ...
          <p>
            Celebrate India's rich culture with beautiful traditional and folk costumes designed for cultural programs, school functions, stage shows and special occasions.
          </p>
        </div>
      </section>

      {/* SLIDER SECTION */}
      <section className="traditional-slider-section">
        <div className="slider-container">
          <div className="slider-top">
            <div>
              <span className="small-label">OUR COLLECTION</span>
              <h2>Celebrate <em>Culture.</em></h2>
            </div>
            ...
            <div className="slider-image-box">
              {images.map((image, index) => (
                <img
                  key={image}
                  src={image}
                  alt={`Traditional and Folk Costume ${index + 1}`}
              ...
              <div className="slide-caption">
                ...
                <h3>Colours of Culture</h3>
                <p>Traditional costumes that bring culture, heritage and celebration beautifully to the stage.</p>
              </div>
          ...
          <div className="traditional-info">
            <div className="info-text">
              ...
              <h2>Cultural Programs,<br />Folk Performances & Events</h2>
              <p>
                Our traditional and folk collection is ideal for school annual functions, cultural events, folk dances, regional themes, celebrations and stage performances.
              </p>
            </div>
            <div className="info-points">
              <div className="info-point">
                ...
                <div>
                  ...
                  <p>Costumes inspired by India's diverse traditional and cultural styles.</p>
                </div>
              </div>
              <div className="info-point">
                <span>02</span>
                <div>
                  <h4>Colourful Designs</h4>
                  <p>Vibrant costumes that create a beautiful stage presence.</p>
                </div>
              </div>
              <div className="info-point">
                <span>03</span>
                <div>
                  ...
                  <p>Perfect costumes for your event without the need to purchase them.</p>
                </div>
              </div>
            </div>
          </div>
...
export default TraditionalFolk;