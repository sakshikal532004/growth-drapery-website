...
const WesternDance = () => {
  ...
  return (
    <div className="western-page">
      <style>{`
        * { box-sizing: border-box; }
        ...
        @media (max-width: 600px) {
          ...
          .western-header { padding: 15px 18px; }
          .header-brand span { font-size: 8px; letter-spacing: 2px; }
          .back-collection-btn { padding: 9px 14px; font-size: 11px; }

          .western-hero { padding: 60px 18px; }
          .western-hero h1 { font-size: 58px; letter-spacing: -3px; }
          .western-hero p { font-size: 14px; }

          .western-slider-section { padding: 20px 18px 70px; }
          ...
          .western-footer { flex-direction: column; align-items: flex-start; padding: 30px 18px; }
        }
      `}</style>
      ...
      {/* HERO */}
      <section className="western-hero">
        <div className="western-hero-content">
          ...
          <p>
            Discover stylish and energetic costumes designed for western dance performances, school functions, competitions, stage shows and special events.
          </p>
        </div>
      </section>

      {/* SLIDER SECTION */}
      <section className="western-slider-section">
        <div className="slider-container">
          <div className="slider-top">
            <div>
              <span className="small-label">OUR COLLECTION</span>
              <h2>Move with <em>Style.</em></h2>
            </div>
            ...
            <div className="slider-image-box">
              {images.map((image, index) => (
                <img
                  key={image}
                  src={image}
                  alt={`Western Dance Costume ${index + 1}`}
              ...
              <div className="slide-caption">
                ...
                <h3>Bold & Energetic</h3>
                <p>Stylish costumes made for energetic performances and unforgettable stage moments.</p>
              </div>
          ...
          <div className="western-info">
            <div className="info-text">
              ...
              <h2>Dance Competitions,<br />School Functions & Shows</h2>
              <p>
                Our western dance collection brings together stylish and performance-ready costumes for school annual functions, dance competitions, stage shows and themed performances.
              </p>
            </div>
            <div className="info-points">
              <div className="info-point">
                ...
                <div>
                  ...
                  <p>Comfortable and attractive costumes designed for stage performances.</p>
                </div>
              </div>
              <div className="info-point">
                <span>02</span>
                <div>
                  <h4>Stylish Looks</h4>
                  <p>Modern and colourful styles for energetic western dance performances.</p>
                </div>
              </div>
              <div className="info-point">
                <span>03</span>
                <div>
                  ...
                  <p>Get the perfect performance look without purchasing expensive costumes.</p>
                </div>
              </div>
            </div>
          </div>
          ...
          <div className="booking-box">
            <div className="booking-content">
              <span>READY FOR YOUR PERFORMANCE?</span>
      ...
      {/* FOOTER */}
      <footer className="western-footer">
        <div>
