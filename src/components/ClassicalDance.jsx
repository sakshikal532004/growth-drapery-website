    ...
    <div className="classical-page">
      <style>{`
        * { box-sizing: border-box; }
        ...
        .back-collection-btn:hover .back-arrow {
          transform: translateX(-4px);
        }
        ...
        .classical-footer div {
          display: flex;
          flex-direction: column;
          gap: 5px;
        }
        .classical-footer strong {
          color: #e8dcc8;
          font-size: 12px;
          letter-spacing: 2px;
        }
        ...
        @media (max-width: 600px) {
          ...
          .classical-header { padding: 15px 18px; }
          .header-brand span { font-size: 8px; letter-spacing: 2px; }
          .back-collection-btn { padding: 9px 14px; font-size: 11px; }

          .classical-hero { padding: 60px 18px; }
          .classical-hero h1 { font-size: 58px; letter-spacing: -3px; }
          .classical-hero p { font-size: 14px; }

          .classical-slider-section { padding: 20px 18px 70px; }
          .slider-top { align-items: flex-end; margin-bottom: 25px; }
          ...
          .classical-footer { flex-direction: column; align-items: flex-start; padding: 30px 18px; }
        }
      `}</style>
      ...
      <section className="classical-hero">
        <div className="classical-hero-content">
          ...
          <p>
            Discover graceful and elegant costumes designed for classical dance performances, school programs, cultural events and stage shows.
          </p>
        </div>
      </section>

      {/* SLIDER */}
      <section className="classical-slider-section">
        <div className="slider-container">
          <div className="slider-top">
            <div>
              <span className="small-label">OUR COLLECTION</span>
              <h2>Grace in <em>Every Move.</em></h2>
            </div>
            ...
            <div className="slider-image-box">
              {images.map((image, index) => (
                <img
                  key={image}
                  src={image}
                  alt={`Classical Dance Costume ${index + 1}`}
              ...
              <div className="slide-caption">
                ...
                <p>Beautiful costumes for memorable classical performances.</p>
              </div>
          ...
          <div className="classical-info">
            <div className="info-text">
              ...
              <h2>School Functions,<br />Competitions & Events</h2>
              <p>
                Our classical dance collection is suitable for Bharatanatyam, Kathak, Krishna themes, cultural performances and school annual functions.
              </p>
            </div>
            <div className="info-points">
              <div className="info-point">
                ...
                <div>
                  <h4>Stage Ready</h4>
                  <p>Costumes designed for beautiful stage presentation.</p>
                </div>
              </div>
              <div className="info-point">
                <span>02</span>
                <div>
                  ...
                  <p>Choose from different classical dance-inspired looks.</p>
                </div>
              </div>
              <div className="info-point">
                <span>03</span>
                <div>
                  ...
                  <p>Perfect for performances without purchasing expensive costumes.</p>
                </div>
              </div>
            </div>
          </div>
