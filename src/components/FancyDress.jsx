    ...
    <div className="fancy-page">
      <style>{`
        * { box-sizing: border-box; }
        ...
        @media (max-width: 600px) {
          ...
          .fancy-header { padding: 15px 18px; }
          .header-brand span { font-size: 8px; letter-spacing: 2px; }
          .back-collection-btn { padding: 9px 14px; font-size: 11px; }

          .fancy-hero { padding: 60px 18px; }
          .fancy-hero h1 { font-size: 55px; letter-spacing: -3px; }
          .fancy-hero p { font-size: 14px; }

          .fancy-slider-section { padding: 20px 18px 70px; }
          ...
          .fancy-footer { flex-direction: column; align-items: flex-start; padding: 30px 18px; }
        }
      `}</style>
      ...
      <section className="fancy-hero">
        <div className="fancy-hero-content">
          ...
          <p>
            Bring imagination to life with colourful and creative fancy dress costumes designed for school competitions, theme events, stage performances and special occasions.
          </p>
        </div>
      </section>

      {/* SLIDER SECTION */}
      <section className="fancy-slider-section">
        <div className="slider-container">
          <div className="slider-top">
            <div>
              <span className="small-label">OUR COLLECTION</span>
              <h2>Express <em>Imagination.</em></h2>
            </div>
            ...
            <div className="slider-image-box">
              {images.map((image, index) => (
                <img
                  key={image}
                  src={image}
                  alt={`Fancy Dress Costume ${index + 1}`}
              ...
              <div className="slide-caption">
                ...
                <h3>Fun, Colours & Characters</h3>
                <p>Creative costumes that transform every school event, competition and celebration into a memorable experience.</p>
              </div>
          ...
          <div className="fancy-info">
            <div className="info-text">
              ...
              <h2>Fancy Dress,<br />Theme Events & Competitions</h2>
              <p>
                Our fancy dress collection is perfect for school fancy dress competitions, annual functions, theme events, special occasions and creative stage performances.
              </p>
            </div>
            <div className="info-points">
              <div className="info-point">
                <span>01</span>
                <div>
                  <h4>Creative Characters</h4>
                  <p>Fun and imaginative costumes for children to bring their characters to life.</p>
                </div>
              </div>
              <div className="info-point">
                <span>02</span>
                <div>
                  ...
                  <p>Eye-catching costumes designed to create a memorable stage presence.</p>
                </div>
              </div>
              <div className="info-point">
                <span>03</span>
                <div>
                  ...
                  <p>Get the right costume for your event without the need to purchase it.</p>
                </div>
              </div>
            </div>
          </div>
